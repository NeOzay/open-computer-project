...
local inv1 = stock_keeper.addStock("e8128c98-105b-4779-a2be-5876d4b0a75b", "fbf061ba-8ee0-477c-8eb1-7ff1aa70138a")
...
inv1:addRecipe(steel, 500)
	:addIngredient(irondust):setSides(sides.south)

stock_keeper.setGlobalRecipeInput(inv1, sides.east)
