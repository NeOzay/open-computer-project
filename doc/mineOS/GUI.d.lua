...
local keyboard = require("mineOS.Keyboard")
local filesystem = require("mineOS.Filesystem")
local event = require("mineOS.Event")
local color = require("mineOS.Color")
local image = require("mineOS.Image")
local screen = require("mineOS.Screen")
--local paths = require("mineOS.Paths")
local text = require("mineOS.Text")
local number = require("mineOS.Number")
-----------------------------------------------------------------------------------------
---@class mineOS.GUI
local GUI = {
...
---@param horizontalAlignment GUI.Horizontal_alignment
---@param verticalAlignment GUI.Vertical_alignment
---@return any
...
---@generic T:GUI.container
---@param object T
---@return T
local function containerObjectMoveForward(object)
	---@cast object GUI.container
...
---@param object GUI.container
local function containerObjectRemove(object)
	table.remove(object.parent.children, containerObjectIndexOf(object))
end

---@param animation GUI.animation
...
local function containerObjectAddAnimation(object, frameHandler, onFinish)
	...
	---@field package removeLater  boolean
	local animation = {
		object = object,
		position = 0,
...
local function workspaceStart(workspace, eventPullTimeout)
	local
		...
		---@param object GUI.object|GUI.container
	...
	local function processObject(object, boundsX1, boundsY1, boundsX2, boundsY2)
		...
		if object.children and boundsX1 and boundsY1 and boundsX2 and boundsY2 then
...
function GUI.workspace(x, y, width, height)
	...
	---@field package needClose boolean
	---@field package animations? GUI.animation[]
	---@field capturedObject? GUI.object
	---@field focusedObject GUI.object
	---@field package eventPullTimeout? number
...
---@param backgroundPressedColor? number
---@param textPressedColor number
---@param backgroundDisabledColor? number
---@param textDisabledColor number
---@param text string
...
local function pressable(x, y, width, height, backgroundColor, textColor, backgroundPressedColor, textPressedColor, backgroundDisabledColor, textDisabledColor, text)
	---@class GUI.pressable: GUI.object
	---@field switchMode boolean
	---@field onTouch fun(workspace: GUI.workspace, pressable: GUI.pressable, ...: any)
...
---@param onFinish fun(animation: GUI.animation)
...
function GUI.actionButtons(x, y, fatSymbol)
	...
	---@class GUI.actionButtons: GUI.container
...
---@param passiveColor number
---@param valueColor number
---@param value number [0; 100]
---@param thin? boolean
---@param showValue? boolean
---@param valuePrefix? string
---@param valuePostfix? string
---@return GUI.progressBar
...
function GUI.alert(...)
	...
	local offset = 2
	---@type string|string[]
	local lines = #args > 1 and "\"" .. table.concat(args, "\", \"") .. "\"" or tostring(args[1])
...
---@param width number
---@param height number
---@param fromSymbol number
---@param fromLine number
---@param maximumLineLength number
---@param selections table
---@param highlights table
---@param syntaxPatterns table
---@param syntaxColorScheme table
---@param syntaxHighlight boolean
---@param lines string[]
---@return GUI.codeView
function GUI.codeView(x, y, width, height, fromSymbol, fromLine, maximumLineLength, selections, highlights, syntaxPatterns, syntaxColorScheme, syntaxHighlight, lines)	
	---@class GUI.codeView : GUI.container
	---@field package lineNumbersWidth number
	---@field package codeAreaPosition number
	---@field package codeAreaWidth number
...
---@param colorSelector GUI.colorSelector
---@return GUI.colorSelector
...
---@param workspace GUI.workspace
---@param object GUI.colorSelector
---@param e1 string
---@param ... any
local function colorSelectorEventHandler(workspace, object, e1, ...)
	if e1 == "touch" then
		...
		palette.submitButton.onTouch = function()
			...
			palette.cancelButton.onTouch(workspace, palette.cancelButton)
		end
...
function GUI.colorSelector(x, y, width, height, color, text)
	---@class GUI.colorSelector: GUI.object
	---@field onColorSelected fun(workspace: GUI.workspace, colorSelector: GUI.colorSelector, e1: string, ...)
...
---@param axisColor integer
---@param axisValueColor integer
---@param axisHelpersColor integer
---@param chartColor integer
---@param xAxisValueInterval integer
---@param yAxisValueInterval integer
---@param xAxisPostfix string
---@param yAxisPostfix string
---@param fillChartArea boolean
---@param values {[1]:number, [2]:number}[]
---@return GUI.chart
function GUI.chart(x, y, width, height, axisColor, axisValueColor, axisHelpersColor, chartColor, xAxisValueInterval, yAxisValueInterval, xAxisPostfix, yAxisPostfix, fillChartArea, values)
	---@class GUI.chart: GUI.object
	---@field roundValues boolean
	local object = GUI.object(x, y, width, height)
...
---@param switchAndLabel GUI.switchAndLabel
...
---@param activeColor number Switch primary color
---@param passiveColor number Switch secondary color
...
function GUI.slider(x, y, width, primaryColor, secondaryColor, pipeColor, valueColor, minimumValue, maximumValue, value, showCornerValues, currentValuePrefix, currentValuePostfix)
	...
	---@field onValueChanged fun(workspace: GUI.workspace, slider: GUI.slider, e1: string, e2: any, e3: any, e4: any, e5: any, ...)
	local object = GUI.object(x, y, width, 1)
	
	object.eventHandler = sliderEventHandler
	object.colors = {active = primaryColor, passive = secondaryColor, pipe = pipeColor, value = valueColor}
	object.draw = sliderDraw
	object.minimumValue = minimumValue
	object.maximumValue = maximumValue
	object.value = value
	object.scrollSensivity = 0.05
	object.showMaximumAndMinimumValues = showCornerValues
...
function GUI.switch(x, y, width, primaryColor, secondaryColor, pipeColor, state)
	...
	---@field onStateChanged fun(switch: GUI.switch, e1: string, ...)
...
---@param array {sizePolicy:GUI.SIZE_POLICY, size:number}[]
---@return integer
...
---@param array {sizePolicy:GUI.SIZE_POLICY, size:number, calculatedSize:number}[]
---@param index integer
---@param dependency number
...
---Forcibly recalculate child objects position. By default, this function will be called automatically, but in some cases it can be helpful.
---@param layout GUI.layout
...
---Assign the specified grid cell to the layout child object. One cell can contain as many objects as you want.
---@generic T:GUI.object
---@param layout GUI.layout
---@param column number
---@param row number
...
---Set grid cell orientation (direction) of the child objects positioning. You can use GUI.DIRECTION_HORIZONTAL or GUI.DIRECTION_VERTICAL.
---@param layout GUI.layout
---@param column integer
---@param row integer
---@param direction GUI.Direction
---@return GUI.layout
...
---Assign the specified grid cell distance in pixels between child objects. The default value is 1.
---@param layout GUI.layout
---@param column integer
---@param row integer
...
---Assign the specified grid cell indents (margins) in pixels, depending on the current alignment of this cell.
---@param layout GUI.layout
---@param column integer
---@param row integer
---@param horizontalMargin integer
---@param verticalMargin integer
---@return GUI.layout
...
---@return GUI.layout.cell
local function layoutNewCell()
	---@class GUI.layout.cell
	---@field direction GUI.Direction
	---@field horizontalAlignment GUI.Horizontal_alignment
	---@field verticalAlignment GUI.Vertical_alignment
	---@field spacing integer
	---@field horizontalFitting boolean
	---@field verticalFitting boolean
	---@field childrenWidth integer
	---@field childrenHeight integer
	---@field x integer
	---@field y integer
	---@field horizontalMargin integer
	---@field verticalMargin integer
	---@field horizontalFittingRemove integer
	---@field verticalFittingRemove integer
	---@field localY integer
	return {
...
---@param changingExistent boolean
---@param array {sizePolicy:GUI.SIZE_POLICY, size:number, calculatedSize:number}[]
---@param index integer
...
---@param layout GUI.layout
---@param column integer
---@param sizePolicy GUI.SIZE_POLICY
---@param size number
---@return GUI.layout
...
---Set height of the specified row. The behavior of the function is similar to :setColumnWidth(...).
---@param layout GUI.layout
---@param row integer
---@param sizePolicy GUI.SIZE_POLICY
---@param size number
...
---Set size of the layout grid. All objects located outside the range of new size must be assigned to required cells again via :setPosition(...).
---@param layout GUI.layout
...
---Assign the specified grid cell automatic resizing of child objects by horizontal, vertical or both directions. By default, new child sizes will be equal the cell size. If optional parameters are specified, then it is possible to set a size reducing, i.e. the size of objects will be equal to Cell size - Offset value.
---@param layout GUI.layout
---@param column integer The column of the grid cell
---@param row integer The row of the grid cell
---@param horizontalFitting boolean The horizontal fitting
---@param verticalFitting boolean The vertical fitting
---@param horizontalOffset? integer The horizontal offset (optional)
---@param verticalOffset? integer The vertical offset (optional)
---@return GUI.layout
local function layoutSetFitting(layout, column, row, horizontalFitting, verticalFitting, horizontalOffset, verticalOffset)
	layoutCheckCell(layout, column, row)
	layout.cells[row][column].horizontalFitting = horizontalFitting
	layout.cells[row][column].verticalFitting = verticalFitting
	layout.cells[row][column].horizontalFittingRemove = horizontalOffset or 0
	layout.cells[row][column].verticalFittingRemove = verticalOffset or 0
...
---@return T
local function layoutAddChild(layout, object, atIndex)
	---@cast object GUI.object
	object.layoutRow = layout.defaultRow
	object.layoutColumn = layout.defaultColumn
	containerAddChild(layout, object, atIndex)

	return object
end

---Creates a new layout object.
---@param x number Layout coordinate by x-axis
---@param y number Layout coordinate by y-axis
---@param width number Layout width
---@param height number Layout height
---@param columnCount number Layout grid column count
---@param rowCount number Layout grid row count
---@return GUI.layout
function GUI.layout(x, y, width, height, columnCount, rowCount)
	---@class GUI.layout: GUI.container
	---@field cells GUI.layout.cell[][]
	---@field columnSizes {sizePolicy:GUI.SIZE_POLICY, size:number, calculatedSize:number}[]
	---@field rowSizes {sizePolicy:GUI.SIZE_POLICY, size:number, calculatedSize:number}[]
...
---@param filesystemDialog GUI.filesystemDialog
---@return GUI.filesystemDialog
...
---@param filesystemDialog GUI.filesystemDialog
---@param IOMode GUI.IO_Mode
---@param filesystemMode GUI.IO_Mode
...
function GUI.filesystemDialog(x, y, width, height, submitButtonText, cancelButtonText, placeholderText, path)
	---@class GUI.filesystemDialog: GUI.container
	---@field IOMode GUI.IO_Mode
	---@field filesystemMode GUI.IO_Mode
	---@field onCancel fun()
	---@field onSubmit fun(path:string)
...
function GUI.filesystemChooser(x, y, width, height, backgroundColor, textColor, tipBackgroundColor, tipTextColor, path, submitButtonText, cancelButtonText, placeholderText, filesystemDialogPath)
	---@class GUI.filesystemChooser: GUI.object
	local object = GUI.object(x, y, width, height)
...
---@param width number Object width
---@param height number Object height
---@param resizerColor number Resizer bar color
---@param arrowColor number Arrow color, it will be shown on touch/drag/drop events
---@return table resizer
function GUI.resizer(x, y, width, height, resizerColor, arrowColor)
	---@class GUI.resizer: GUI.object
	---@field package lastTouchX number
	---@field package lastTouchY number
	---@field onResize fun(dragWidth:number, dragHeight:number)
	---@field onResizeFinished fun()
	local object = GUI.object(x, y, width, height)
...
function GUI.scrollBar(x, y, width, height, backgroundColor, foregroundColor, minimumValue, maximumValue, value, shownValueCount, onScrollValueIncrement, thin)
	---@class GUI.scrollBar: GUI.object
	---@field onTouch fun(workspace:GUI.workspace, object:GUI.scrollBar, e1:string, e2:any, e3:any, e4:any, e5:any, ...):any
...
---@param expandableColor integer
---@param notExpandableColor integer
---@param arrowColor integer
---@param backgroundSelectedColor integer
---@param anySelectionColor integer
---@param arrowSelectionColor integer
---@param disabledColor integer
---@param scrollBarBackground integer
---@param scrollBarForeground integer
---@param showMode any
---@param selectionMode any
---@return GUI.tree
function GUI.tree(x, y, width, height, backgroundColor, expandableColor, notExpandableColor, arrowColor, backgroundSelectedColor, anySelectionColor, arrowSelectionColor, disabledColor, scrollBarBackground, scrollBarForeground, showMode, selectionMode)
	...
	---@field items GUI.tree.item[]
	---@field selectedItem string
	---@field onItemExpanded fun(selectedItem:GUI.tree.item, e1:string, e2:any, e3:any, e4:any, e5:any, ...)
	---@field onItemSelected fun(selectedItem:string, e1:string, e2:any, e3:any, e4:any, e5:any, ...)
...
---@param showMode any
---@param selectionMode any
---@return GUI.filesystemTree
function GUI.filesystemTree(x, y, width, height, backgroundColor, expandableColor, notExpandableColor, arrowColor, backgroundSelectedColor, anySelectionColor, arrowSelectionColor, disabledColor, scrollBarBackground, scrollBarForeground, showMode, selectionMode)
	---@class GUI.filesystemTree: GUI.tree
	---@field extensionFilters table<string, boolean>
	local tree = GUI.tree(x, y, width, height, backgroundColor, expandableColor, notExpandableColor, arrowColor, backgroundSelectedColor, anySelectionColor, arrowSelectionColor, disabledColor, scrollBarBackground, scrollBarForeground, showMode, selectionMode)
...
local function textBoxUpdate(object)
	...
	if object.autoWrap then
		for i = 1, #object.lines do
			...
			for subLine in (isTable and object.lines[i].text or object.lines[i]--[[@as string]]):gmatch("[^\n]+") do
...
---@param lines {text:string, color:integer}[]
---@param currentLine integer
---@param horizontalOffset integer
...
function GUI.textBox(x, y, width, height, backgroundColor, textColor, lines, currentLine, horizontalOffset, verticalOffset, autoWrap, autoHeight)
	...
	---@field linesCopy {text:string, color:integer}[]
	local object = GUI.object(x, y, width, height)
...
local function inputStopInput(input)
	...
	if input.onInputFinished then
		input.onInputFinished(input.workspace, input)
	end
end
...
function GUI.input(x, y, width, height, backgroundColor, textColor, placeholderTextColor, backgroundFocusedColor, textFocusedColor, text, placeholderText, eraseTextOnFocus, textMask)
	...
	---@field cursorBlinkUptime number
	---@field validator fun(text:string):boolean
	---@field onInputFinished fun(workspace:GUI.workspace, object:GUI.input)
...
function GUI.autoComplete(x, y, width, maximumHeight, backgroundColor, textColor, textMatchColor, backgroundSelectedColor, textSelectedColor, textMatchSelectedColor, scrollBarBackground, scrollBarForeground)
	---@class GUI.autoComplete: GUI.object
...
---@param brailleCanvas GUI.brailleCanvas
---@return GUI.brailleCanvas
...
function GUI.brailleCanvas(x, y, width, height)
	---@class GUI.brailleCanvas: GUI.object
...
function GUI.palette(x, y, startColor)
	...
	local paletteConfigPath = "/etc/GUI/palette.cfg"
	...
	palette:addChild(GUI.button(58, 25, 12, 1, 0xFFFFFF, 0x4B4B4B, 0x2D2D2D, 0xFFFFFF, "+")).onTouch = function(workspace)
		...
		if not favouriteExists then
			---@cast favourites table
			table.insert(favourites, 1, palette.color.integer)
			table.remove(favourites, #favourites)
			for i = 1, #favourites do
				favouritesContainer.children[i]--[[@as GUI.button]].colors.default.background = favourites[i]
				favouritesContainer.children[i]--[[@as GUI.button]].colors.pressed.background = 0x0
			end
...
---@param text string Object text
---@return GUI.text
function GUI.text(x, y, textColor, text, transparency)
...
---@param parentContainer GUI.container
---@param addPanel boolean
---@param addLayout boolean
---@param title? string
---@return GUI.container
...
---@return GUI.list
local function listSetAlignment(list, horizontalAlignment, verticalAlignment)
	layoutSetAlignment(list, 1, 1, horizontalAlignment, verticalAlignment)
	return list
end
...
---@return GUI.list
local function listSetSpacing(list, spacing)
	layoutSetSpacing(list, 1, 1, spacing)
	return list
end
...
---@return GUI.list
local function listSetDirection(list, direction)
	layoutSetDirection(list, 1, 1, direction)
	return list
end
...
---@param verticalOffset? integer The vertical offset (optional)
---@return GUI.list
local function listSetFitting(list, horizontalFitting, verticalFitting, horizontalOffset, verticalOffset)
	layoutSetFitting(list, 1, 1, horizontalFitting, verticalFitting, horizontalOffset, verticalOffset)
	return list
end
...
---@return GUI.list
local function listSetMargin(list, horizontalMargin, verticalMargin)
	layoutSetMargin(list, 1, 1, horizontalMargin, verticalMargin)
	return list
end
...
---@param list GUI.list
---@param index integer|string The index of the item
---@return GUI.list.pressable?, integer?
local function listGetItem(list, index)
	if type(index) == "number" then
		return list.children[index]
	else
		for i = 1, #list.children do
			if list.children[i].text == index then
...
---@class GUI.list.pressable : GUI.pressable
---@field parent GUI.list
...
function GUI.list(x, y, width, height, itemSize, spacing, backgroundColor, textColor, alternateBackgroundColor, alternateTextColor, backgroundSelectedColor, textSelectedColor, offsetMode)
	...
	---@field children GUI.list.pressable[]
...
---@param x integer
---@param y integer
---@param keyColor integer
---@param valueColor integer
---@param key string
---@param value string
---@return GUI.keyAndValue
function GUI.keyAndValue(x, y, keyColor, valueColor, key, value)
	---@class GUI.keyAndValue: GUI.object
	---@field keyLength number
...
---@param item GUI.dropDownMenu.item
---@return any
...
---@param menu GUI.dropDownMenu
---@return GUI.dropDownMenu
...
---@param workspace GUI.workspace
---@param object GUI.dropDownMenu.item
---@param e1 string
---@param ... any
		...
		if object.isTextItem and not object.pressed then
			...
			if object.subMenu then
				...
				for i = 2, #object.parent.parent.parent.children do
					if object.parent.parent.parent.children[i]--[[@as GUI.dropDownMenu]].onMenuClosed then
						object.parent.parent.parent.children[i]--[[@as GUI.dropDownMenu]].onMenuClosed(objectIndex)
					end
				end
...
---@param a4 any
---@param a5 any
---@return GUI.dropDownMenu.item
local function dropDownMenuAddItem(menu, a1, a2, a3, a4, a5)
	---@class GUI.dropDownMenu.item: GUI.object
	---@field pressed boolean
	---@field parent GUI.dropDownMenu.itemsContainer
	---@field subMenu GUI.dropDownMenu.subMenu
	---@field onMenuClosed fun()
	---@field onTouch fun(workspace: GUI.workspace, object: GUI.dropDownMenu.item, e1: string, ...)
...
local function dropDownMenuPrevButtonOnTouch(workspace, button)
	dropDownMenuScrollDown(workspace, button.parent --[[@as GUI.dropDownMenu]])
end

---@param workspace GUI.workspace
---@param button GUI.button
local function dropDownMenuNextButtonOnTouch(workspace, button)
	dropDownMenuScrollUp(workspace, button.parent  --[[@as GUI.dropDownMenu]])
end
...
---@param y integer
---@param width integer
---@param maximumHeight integer
---@param itemHeight integer
---@param backgroundColor integer
---@param iconColor integer
---@param textColor integer
---@param backgroundPressedColor integer
---@param iconPressedColor integer
---@param textPressedColor integer
---@param disabledIconColor integer
---@param disabledTextColor integer
---@param separatorColor integer
---@param backgroundTransparency number
---@param shadowTransparency number
---@return GUI.dropDownMenu
function GUI.dropDownMenu(
	...
	---@class GUI.dropDownMenu: GUI.container
	---@field onMenuClosed fun(selectedIndex:integer)
	...
	---@class GUI.dropDownMenu.itemsContainer: GUI.container
	---@field children GUI.dropDownMenu.item[]
	---@field parent GUI.dropDownMenu
...
contextMenuCreate = function(x, y, backgroundColor, textColor, backgroundPressedColor, textPressedColor, disabledColor, separatorColor, backgroundTransparency, shadowTransparency)
	---@class GUI.dropDownMenu.subMenu: GUI.dropDownMenu
	---@field package addSubMenuItem unknown
...
---@param parentContainer table Container to which context menu will be added
---@param x number Local coordinate by x-axis in parent container
---@param y number Local coordinate by y-axis in parent container
---@param backgroundColor number Optional default background color
---@param textColor number Optional default text color
---@param backgroundPressedColor number Optional pressed item background color
---@param textPressedColor number Optional pressed item text color
---@param disabledColor number Optional disabled item text color
---@param separatorColor number Optional separator text color
---@param backgroundTransparency number [0.0, 1.0] Optional background transparency
---@param shadowTransparency number [0.0, 1.0] Optional shadow transparency
---@return GUI.dropDownMenu
---@overload fun(parentContainer: GUI.container, menu: GUI.dropDownMenu): GUI.dropDownMenu
function GUI.addContextMenu(parentContainer, x, y, backgroundColor, textColor, backgroundPressedColor, textPressedColor, disabledColor, separatorColor, backgroundTransparency, shadowTransparency)
	if type(x) == "table" then
		return dropDownMenuAdd(parentContainer, x)
	else
		return dropDownMenuAdd(parentContainer, contextMenuCreate(x, y, backgroundColor, textColor, backgroundPressedColor, textPressedColor, disabledColor, separatorColor, backgroundTransparency, shadowTransparency))
	end
end

--------------------------------------------------------------------------------

---@param object GUI.comboBox
---@return GUI.comboBox
...
---@return GUI.dropDownMenu.item?
---@overload fun(object: GUI.comboBox, name: string): GUI.dropDownMenu.item?, index: integer
...
---@param color? integer
---@return GUI.dropDownMenu.item
local function comboBoxAddItem(object, text, disable, shortcut, color)
	return object.dropDownMenu:addItem(text, disable, shortcut, color)
end
...
---@param x number Combo box coordinate by x-axis
---@param y number Combo box coordinate by y-axis
---@param width number Combo box width
---@param elementHeight number Combo box item height
---@param backgroundColor number Combo box background color
---@param textColor number Combo box text color
---@param arrowBackgroundColor number Combo box arrow background color
---@param arrowTextColor number Combo box arrow text color
---@return GUI.comboBox
function GUI.comboBox(x, y, width, elementHeight, backgroundColor, textColor, arrowBackgroundColor, arrowTextColor)
	...
	local comboBox = GUI.object(x, y, width, elementHeight)
...
---@param animationDisabled boolean
function GUI.windowMaximize(window, animationDisabled)
	...
	if window.maximized then
		...
		if window.maxWidth then
			toWidth = math.min(toWidth, window.maxWidth --[[@as number]])
		end
		
		if window.maxHeight then
			toHeight = math.min(toHeight, window.maxHeight --[[@as number]])
		end
...
function GUI.window(x, y, width, height)
	---@class GUI.window : GUI.container
	---@field oldGeometryX number?
	---@field oldGeometryY number?
	---@field oldGeometryWidth number?
	---@field oldGeometryHeight number?
	---@field maximized boolean?
	---@field maxWidth boolean?
	---@field maxHeight boolean?
	---@field onFocus fun()
...
---@param text string
---@param textColor integer
---@return GUI.dropDownMenu.subMenu
local function menuAddContextMenuItem(menu, text, textColor)
	---@class GUI.menu.ContextMenuItem: GUI.pressable
	local item = menu:addItem(text, textColor)
...
---@param x integer  Object coordinate by x-axis
---@param y integer Object coordinate by y-axis
---@param width integer Object width
---@param backgroundColor integer Object background color
---@param textColor integer Object text color
---@param backgroundPressedColor integer Object background pressed color
---@param textPressedColor integer Object text pressed color
---@param backgroundTransparency integer Optional background transparency
---@return GUI.menu
function GUI.menu(x, y, width, backgroundColor, textColor, backgroundPressedColor, textPressedColor, backgroundTransparency)
	---@class GUI.menu : GUI.container
	local menu = GUI.container(x, y, width, 1)
...
---------------------------------------------------------------------------------------------------
---@param self GUI.progressIndicator
...
---@param x number Indicator coordinate by x-axis
---@param y number Indicator coordinate by y-axis
---@param passiveColor number Initial indicator color in passive state
---@param primaryColor number Primary indicator color in active state
---@param secondaryColor number Secondary indicator color in active state
---@return GUI.progressIndicator
function GUI.progressIndicator(x, y, passiveColor, primaryColor, secondaryColor)
	---@class GUI.progressIndicator : GUI.object
