...
---
---Additional arguments are passed directly to the first program started based on the command, so you can pass non-string values to programs.
---
---Returns values similar to pcall and coroutine.resume: the first returned value is a boolean indicating success or error.
---
