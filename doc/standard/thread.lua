...
---@return thread
---@overload fun(thread_proc: function, ...): table
...
---@param threads table @thread table
---@return boolean,string
---@overload fun(threads: table, timeout: number): boolean, string
...
---@return boolean,string
---@overload fun(threads: table, timeout: number): boolean, string
function thread.waitForAny(threads) end
...
---@return boolean, string
---@overload fun(level: number): boolean, string
function t:attach() end
...
---@return boolean, string
---@overload fun(timeout: number): boolean, string
function t:join() end
