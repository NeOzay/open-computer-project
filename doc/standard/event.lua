...
---@param callback function
---@return number
---@overload fun(interval: number, callback: function, times: number): number
function event.timer(interval,callback) end
...
---@param name string
---@return string,any...
---@overload fun(timeout: number, name: string, ...): string, any...
